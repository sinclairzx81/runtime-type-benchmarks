...
export function Execute(iterations: number) {
  ...
  Cases.Benchmark(Cases.Array_Object_Simple, iterations, results, () => (value) => Typia.is<Cases.Array_Object_Simple>(value))
  Cases.Benchmark(Cases.Array_Object_Strict, iterations, results, () => (value) => Typia.equals<Cases.Array_Object_Strict>(value))
