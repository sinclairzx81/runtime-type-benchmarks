...
export function Execute(iterations: number) {
  ...
  Cases.Benchmark(Cases.Array_Object, iterations, results, () => {
    function check_Array_Object(value) {
      return Array.isArray(value) && value.every((value) => typeof value === 'object' && value !== null && typeof value.x === 'number' && typeof value.y === 'number' && typeof value.z === 'number')
    }
    return function check(value) {
  ...
  Cases.Benchmark(Cases.Array_Union, iterations, results, () => {
    function check_Array_Union(value) {
      return (
        ...
        value.every(
          (value) =>
            (typeof value === 'object' && value !== null && value.type === 'Vector2' && typeof value.x === 'number' && typeof value.y === 'number') ||
            (typeof value === 'object' && value !== null && value.type === 'Vector3' && typeof value.x === 'number' && typeof value.y === 'number' && typeof value.z === 'number') ||
            (typeof value === 'object' && value !== null && value.type === 'Vector4' && typeof value.x === 'number' && typeof value.y === 'number' && typeof value.z === 'number' && typeof value.w === 'number'),
        )
      )
    }
    return function check(value) {
