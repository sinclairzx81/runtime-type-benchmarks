...
export function Execute(iterations: number) {
  ...
  Cases.Benchmark(Cases.Array_Composite_Intersect, iterations, results, () => {
    ...
    function check_Array_Composite_Intersect(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Composite_Intersect(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Composite_Intersect(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Composite_Union_Discriminated, iterations, results, () => {
    ...
    function check_Array_Composite_Union_Discriminated(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Composite_Union_Discriminated(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Composite_Union_Discriminated(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Composite_Union_Literal, iterations, results, () => {
    ...
    function check_Array_Composite_Union_Literal(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Composite_Union_Literal(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Composite_Union_Literal(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Composite_Union_Non_Discriminated, iterations, results, () => {
    ...
    function check_Array_Composite_Union_Non_Discriminated(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Composite_Union_Non_Discriminated(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Composite_Union_Non_Discriminated(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Math_Box3D, iterations, results, () => {
    ...
    function check_Array_Math_Box3D(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Math_Box3D(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Math_Box3D(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Math_Matrix4, iterations, results, () => {
    ...
    function check_Array_Math_Matrix4(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Math_Matrix4(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Math_Matrix4(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Math_Mesh, iterations, results, () => {
    ...
    function check_Array_Math_Mesh(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Math_Mesh(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Math_Mesh(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Math_Vector3, iterations, results, () => {
    ...
    function check_Array_Math_Vector3(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Math_Vector3(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Math_Vector3(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Object_Loose, iterations, results, () => {
    function check_Object_Loose(value) {
      return (
      (typeof value === 'object' && value !== null && !Array.isArray(value)) &&
      (typeof value.A === 'number' && !isNaN(value.A)) &&
      (typeof value.B === 'number' && !isNaN(value.B)) &&
      (typeof value.C === 'number' && !isNaN(value.C)) &&
      (typeof value.D === 'string') &&
      (typeof value.E === 'string') &&
      (typeof value.F === 'boolean') &&
      (typeof value.G === 'object' && value.G !== null && !Array.isArray(value.G)) &&
      (typeof value.G.H === 'string') &&
      (typeof value.G.I === 'number' && !isNaN(value.G.I)) &&
      (typeof value.G.J === 'boolean')
      )
    }
    function check_Array_Object_Loose(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Object_Loose(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Object_Loose(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Object_Partial, iterations, results, () => {
    function check_Object_Partial(value) {
      return (
      (typeof value === 'object' && value !== null && !Array.isArray(value)) &&
      (value.position === undefined ? true : (((typeof value.position === 'object' && value.position !== null && !Array.isArray(value.position)) && (typeof value.position.x === 'number' && !isNaN(value.position.x)) && (typeof value.position.y === 'number' && !isNaN(value.position.y)) && (typeof value.position.z === 'number' && !isNaN(value.position.z))))) &&
      (value.rotation === undefined ? true : (((typeof value.rotation === 'object' && value.rotation !== null && !Array.isArray(value.rotation)) && (typeof value.rotation.x === 'number' && !isNaN(value.rotation.x)) && (typeof value.rotation.y === 'number' && !isNaN(value.rotation.y)) && (typeof value.rotation.z === 'number' && !isNaN(value.rotation.z))))) &&
      (value.scale === undefined ? true : (((typeof value.scale === 'object' && value.scale !== null && !Array.isArray(value.scale)) && (typeof value.scale.x === 'number' && !isNaN(value.scale.x)) && (typeof value.scale.y === 'number' && !isNaN(value.scale.y)) && (typeof value.scale.z === 'number' && !isNaN(value.scale.z)))))
      )
    }
    function check_Array_Object_Partial(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Object_Partial(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Object_Partial(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Object_Required, iterations, results, () => {
    function check_Object_Required(value) {
      ...
      (typeof value.position.y === 'number' && !isNaN(value.position.y)) &&
      (typeof value.position.z === 'number' && !isNaN(value.position.z)) &&
      (typeof value.rotation === 'object' && value.rotation !== null && !Array.isArray(value.rotation)) &&
      (typeof value.rotation.x === 'number' && !isNaN(value.rotation.x)) &&
      (typeof value.rotation.y === 'number' && !isNaN(value.rotation.y)) &&
      (typeof value.rotation.z === 'number' && !isNaN(value.rotation.z)) &&
      (typeof value.scale === 'object' && value.scale !== null && !Array.isArray(value.scale)) &&
      (typeof value.scale.x === 'number' && !isNaN(value.scale.x)) &&
      (typeof value.scale.y === 'number' && !isNaN(value.scale.y)) &&
      (typeof value.scale.z === 'number' && !isNaN(value.scale.z))
    ...
    function check_Array_Object_Required(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Object_Required(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Object_Required(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Object_Strict, iterations, results, () => {
    ...
    function check_Array_Object_Strict(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Object_Strict(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Object_Strict(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Primitive_Boolean, iterations, results, () => {
    function check_Array_Primitive_Boolean(value) {
      return (
      (Array.isArray(value) && value.every(value => ((typeof value === 'boolean')))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Primitive_Boolean(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Primitive_Number, iterations, results, () => {
    ...
    return function check(value) {
      return (
      (check_Array_Primitive_Number(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Primitive_String, iterations, results, () => {
    ...
    return function check(value) {
      return (
      (check_Array_Primitive_String(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Recursive_Object, iterations, results, () => {
    ...
    return function check(value) {
      return (
      (check_Array_Recursive_Object(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Recursive_Union, iterations, results, () => {
    function check_Recursive_Union(value) {
      return (
      (((typeof value === 'object' && value !== null && !Array.isArray(value)) && (value.type === 'Node') && (Array.isArray(value.nodes) && value.nodes.every(value => ((check_Recursive_Union(value)))))) || ((typeof value === 'object' && value !== null && !Array.isArray(value)) && (value.type === 'Leaf') && (typeof value.value === 'string')))
      )
    }
    function check_Array_Recursive_Union(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Recursive_Union(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Recursive_Union(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Tuple_Number, iterations, results, () => {
    ...
    function check_Array_Tuple_Number(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Tuple_Number(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Tuple_Number(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Tuple_Object, iterations, results, () => {
    ...
    function check_Array_Tuple_Object(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Tuple_Object(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Tuple_Object(value))
      )
    }
  })
  Cases.Benchmark(Cases.Array_Tuple_Union_Literal, iterations, results, () => {
    ...
    function check_Array_Tuple_Union_Literal(value) {
      return (
      (Array.isArray(value) && value.every(value => ((check_Tuple_Union_Literal(value))))) &&
      (value.length >= 8)
      )
    }
    return function check(value) {
      return (
      (check_Array_Tuple_Union_Literal(value))
      )
    }
  })
