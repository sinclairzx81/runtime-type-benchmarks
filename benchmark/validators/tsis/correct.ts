...
export function Execute(iterations: number) {
  ...
  Cases.Benchmark(Cases.Boolean_Boolean, iterations, results, () => (value) => Tsis.is<Cases.Boolean_Boolean>(value))
  ...
  Cases.Benchmark(Cases.Composite_Union_String_Literal, iterations, results, () => (value) => Tsis.is<Cases.Composite_Union_String_Literal>(value))
  ...
  Cases.Benchmark(Cases.Math_Transform3D, iterations, results, () => (value) => Tsis.is<Cases.Math_Transform3D>(value))
  Cases.Benchmark(Cases.Math_Vector3, iterations, results, () => (value) => Tsis.is<Cases.Math_Vector3>(value))
  Cases.Benchmark(Cases.Null_Null, iterations, results, () => (value) => Tsis.is<Cases.Null_Null>(value))
  Cases.Benchmark(Cases.Number_Number, iterations, results, () => (value) => Tsis.is<Cases.Number_Number>(value))
  ...
  Cases.Benchmark(Cases.Tuple_Union_String_Literal, iterations, results, () => (value) => Tsis.is<Cases.Tuple_Union_String_Literal>(value))
