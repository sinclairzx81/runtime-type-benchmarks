...
export function Execute(iterations: number) {
  ...
  // Cases.Benchmark(Cases.Primitive_Undefined, iterations, results, () => (value) => Tsrc.is<Cases.Primitive_Undefined>(value))
  // Cases.Benchmark(Cases.Primitive_RegEx, iterations, results, () => (value) => Tsrc.is<Cases.Primitive_RegEx>(value))
  // Cases.Benchmark(Cases.Literal_Boolean, iterations, results, () => (value) => Tsrc.is<Cases.Literal_Boolean>(value))
  ...
  Cases.Benchmark(Cases.Object_Required, iterations, results, () => (value) => Tsrc.is<Cases.Object_Required>(value))
  ...
  // Cases.Benchmark(Cases.Composite_Union_Discriminated, iterations, results, () => (value) => Tsrc.is<Cases.Composite_Union_Discriminated>(value))
  // Cases.Benchmark(Cases.Composite_Union_Non_Discriminated, iterations, results, () => (value) => Tsrc.is<Cases.Composite_Union_Non_Discriminated>(value))
  Cases.Benchmark(Cases.Composite_Intersect, iterations, results, () => (value) => Tsrc.is<Cases.Composite_Intersect>(value))
  // Cases.Benchmark(Cases.Recursive_Object, iterations, results, () => (value) => Tsrc.is<Cases.Recursive_Object>(value))
  // Cases.Benchmark(Cases.Recursive_Union, iterations, results, () => (value) => Tsrc.is<Cases.Recursive_Union>(value))
  ...
  Cases.Benchmark(Cases.Array_Object_Required, iterations, results, () => (value) => Tsrc.is<Cases.Array_Object_Required>(value))
  ...
  // Cases.Benchmark(Cases.Array_Recursive_Object, iterations, results, () => (value) => Tsrc.is<Cases.Array_Recursive_Object>(value))
  // Cases.Benchmark(Cases.Array_Recursive_Union, iterations, results, () => (value) => Tsrc.is<Cases.Array_Recursive_Union>(value))
