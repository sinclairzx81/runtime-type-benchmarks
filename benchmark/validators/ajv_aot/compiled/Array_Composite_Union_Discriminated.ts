    ...
    if (Array.isArray(data)) {
      if (data.length < 8) {
        ...
        for (let i0 = 0; i0 < len0; i0++) {
              ...
              if (!valid1) {
                ...
                if (!valid1) {
                  ...
                  if (errors === _errs27) {
                    if (data0 && typeof data0 == 'object' && !Array.isArray(data0)) {
                      let missing4
                      if ((data0.type === undefined && (missing4 = 'type')) || (data0.value === undefined && (missing4 = 'value'))) {
                        const err20 = { instancePath: instancePath + '/' + i0, schemaPath: '#/items/anyOf/4/required', keyword: 'required', params: { missingProperty: missing4 }, message: "must have required property '" + missing4 + "'" }
                        if (vErrors === null) {
                          vErrors = [err20]
                        } else {
                          vErrors.push(err20)
                        ...
                        if (data0.type !== undefined) {
                          ...
                          if (typeof data9 !== 'string') {
                            const err21 = { instancePath: instancePath + '/' + i0 + '/type', schemaPath: '#/items/anyOf/4/properties/type/type', keyword: 'type', params: { type: 'string' }, message: 'must be string' }
                            if (vErrors === null) {
                              vErrors = [err21]
                            } else {
                              vErrors.push(err21)
                          ...
                          if ('E' !== data9) {
                            const err22 = { instancePath: instancePath + '/' + i0 + '/type', schemaPath: '#/items/anyOf/4/properties/type/const', keyword: 'const', params: { allowedValue: 'E' }, message: 'must be equal to constant' }
                            if (vErrors === null) {
                              vErrors = [err22]
                            } else {
                              vErrors.push(err22)
                        ...
                        if (valid6) {
                          if (data0.value !== undefined) {
                            let data10 = data0.value
                            const _errs31 = errors
                            if (!(typeof data10 == 'number' && isFinite(data10))) {
                              const err23 = { instancePath: instancePath + '/' + i0 + '/value', schemaPath: '#/items/anyOf/4/properties/value/type', keyword: 'type', params: { type: 'number' }, message: 'must be number' }
                              if (vErrors === null) {
                                vErrors = [err23]
                              } else {
                                vErrors.push(err23)
                      ...
                      const err24 = { instancePath: instancePath + '/' + i0, schemaPath: '#/items/anyOf/4/type', keyword: 'type', params: { type: 'object' }, message: 'must be object' }
                      if (vErrors === null) {
                        vErrors = [err24]
                      } else {
                        vErrors.push(err24)
                  ...
                  if (!valid1) {
                    ...
                    if (errors === _errs33) {
                      if (data0 && typeof data0 == 'object' && !Array.isArray(data0)) {
                        let missing5
                        if ((data0.type === undefined && (missing5 = 'type')) || (data0.value === undefined && (missing5 = 'value'))) {
                          const err25 = { instancePath: instancePath + '/' + i0, schemaPath: '#/items/anyOf/5/required', keyword: 'required', params: { missingProperty: missing5 }, message: "must have required property '" + missing5 + "'" }
                          if (vErrors === null) {
                            vErrors = [err25]
                          } else {
                            vErrors.push(err25)
                          ...
                          if (data0.type !== undefined) {
                            let data11 = data0.type
                            const _errs35 = errors
                            if (typeof data11 !== 'string') {
                              const err26 = { instancePath: instancePath + '/' + i0 + '/type', schemaPath: '#/items/anyOf/5/properties/type/type', keyword: 'type', params: { type: 'string' }, message: 'must be string' }
                              if (vErrors === null) {
                                vErrors = [err26]
                              } else {
                                vErrors.push(err26)
                            ...
                            if ('F' !== data11) {
                              const err27 = { instancePath: instancePath + '/' + i0 + '/type', schemaPath: '#/items/anyOf/5/properties/type/const', keyword: 'const', params: { allowedValue: 'F' }, message: 'must be equal to constant' }
                              if (vErrors === null) {
                                vErrors = [err27]
                              } else {
                                vErrors.push(err27)
                          ...
                          if (valid7) {
                            if (data0.value !== undefined) {
                              let data12 = data0.value
                              const _errs37 = errors
                              if (!(typeof data12 == 'number' && isFinite(data12))) {
                                const err28 = { instancePath: instancePath + '/' + i0 + '/value', schemaPath: '#/items/anyOf/5/properties/value/type', keyword: 'type', params: { type: 'number' }, message: 'must be number' }
                                if (vErrors === null) {
                                  vErrors = [err28]
                                } else {
                                  vErrors.push(err28)
                        ...
                        const err29 = { instancePath: instancePath + '/' + i0, schemaPath: '#/items/anyOf/5/type', keyword: 'type', params: { type: 'object' }, message: 'must be object' }
                        if (vErrors === null) {
                          vErrors = [err29]
                        } else {
                          vErrors.push(err29)
                    ...
                    if (!valid1) {
                      ...
                      if (errors === _errs39) {
                        if (data0 && typeof data0 == 'object' && !Array.isArray(data0)) {
                          let missing6
                          if ((data0.type === undefined && (missing6 = 'type')) || (data0.value === undefined && (missing6 = 'value'))) {
                            const err30 = {
                            ...
                            if (data0.type !== undefined) {
                              let data13 = data0.type
                              const _errs41 = errors
                              if (typeof data13 !== 'string') {
                                const err31 = { instancePath: instancePath + '/' + i0 + '/type', schemaPath: '#/items/anyOf/6/properties/type/type', keyword: 'type', params: { type: 'string' }, message: 'must be string' }
                                if (vErrors === null) {
                                  vErrors = [err31]
                                } else {
                                  vErrors.push(err31)
                              ...
                              if ('G' !== data13) {
                                const err32 = { instancePath: instancePath + '/' + i0 + '/type', schemaPath: '#/items/anyOf/6/properties/type/const', keyword: 'const', params: { allowedValue: 'G' }, message: 'must be equal to constant' }
                                if (vErrors === null) {
                                  vErrors = [err32]
                                } else {
                                  vErrors.push(err32)
                            ...
                            if (valid8) {
                              if (data0.value !== undefined) {
                                let data14 = data0.value
                                const _errs43 = errors
                                if (!(typeof data14 == 'number' && isFinite(data14))) {
                                  const err33 = { instancePath: instancePath + '/' + i0 + '/value', schemaPath: '#/items/anyOf/6/properties/value/type', keyword: 'type', params: { type: 'number' }, message: 'must be number' }
                                  if (vErrors === null) {
                                    vErrors = [err33]
                                  } else {
                                    vErrors.push(err33)
                          ...
                          const err34 = { instancePath: instancePath + '/' + i0, schemaPath: '#/items/anyOf/6/type', keyword: 'type', params: { type: 'object' }, message: 'must be object' }
                          if (vErrors === null) {
                            vErrors = [err34]
                          } else {
                            vErrors.push(err34)
                      ...
                      if (!valid1) {
                        ...
                        if (errors === _errs45) {
                          if (data0 && typeof data0 == 'object' && !Array.isArray(data0)) {
                            let missing7
                            if ((data0.type === undefined && (missing7 = 'type')) || (data0.value === undefined && (missing7 = 'value'))) {
                              const err35 = {
                                instancePath: instancePath + '/' + i0,
                                schemaPath: '#/items/anyOf/7/required',
                                keyword: 'required',
                              ...
                              if (data0.type !== undefined) {
                                ...
                                if (typeof data15 !== 'string') {
                                  const err36 = { instancePath: instancePath + '/' + i0 + '/type', schemaPath: '#/items/anyOf/7/properties/type/type', keyword: 'type', params: { type: 'string' }, message: 'must be string' }
                                  if (vErrors === null) {
                                    vErrors = [err36]
                                  } else {
                                    vErrors.push(err36)
                                ...
                                if ('H' !== data15) {
                                  const err37 = { instancePath: instancePath + '/' + i0 + '/type', schemaPath: '#/items/anyOf/7/properties/type/const', keyword: 'const', params: { allowedValue: 'H' }, message: 'must be equal to constant' }
                                  if (vErrors === null) {
                                    vErrors = [err37]
                                  } else {
                                    vErrors.push(err37)
                              ...
                              if (valid9) {
                                if (data0.value !== undefined) {
                                  let data16 = data0.value
                                  const _errs49 = errors
                                  if (!(typeof data16 == 'number' && isFinite(data16))) {
                                    const err38 = { instancePath: instancePath + '/' + i0 + '/value', schemaPath: '#/items/anyOf/7/properties/value/type', keyword: 'type', params: { type: 'number' }, message: 'must be number' }
                                    if (vErrors === null) {
                                      vErrors = [err38]
                                    } else {
                                      vErrors.push(err38)
                            ...
                            const err39 = { instancePath: instancePath + '/' + i0, schemaPath: '#/items/anyOf/7/type', keyword: 'type', params: { type: 'object' }, message: 'must be object' }
                            if (vErrors === null) {
                              vErrors = [err39]
                            } else {
                              vErrors.push(err39)
          ...
          if (!valid1) {
            const err40 = { instancePath: instancePath + '/' + i0, schemaPath: '#/items/anyOf', keyword: 'anyOf', params: {}, message: 'must match a schema in anyOf' }
            if (vErrors === null) {
              vErrors = [err40]
            } else {
              vErrors.push(err40)
