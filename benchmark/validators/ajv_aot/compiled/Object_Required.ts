...
function validate10(data, { instancePath = '', parentData, parentDataProperty, rootData = data } = {}) {
  ...
  if (errors === 0) {
    if (data && typeof data == 'object' && !Array.isArray(data)) {
      let missing0
      if ((data.position === undefined && (missing0 = 'position')) || (data.rotation === undefined && (missing0 = 'rotation')) || (data.scale === undefined && (missing0 = 'scale'))) {
          ...
          if (errors === _errs1) {
            if (data0 && typeof data0 == 'object' && !Array.isArray(data0)) {
              ...
              if ((data0.x === undefined && (missing1 = 'x')) || (data0.y === undefined && (missing1 = 'y')) || (data0.z === undefined && (missing1 = 'z'))) {
                validate10.errors = [
                  { instancePath: instancePath + '/position', schemaPath: '#/properties/position/required', keyword: 'required', params: { missingProperty: missing1 }, message: "must have required property '" + missing1 + "'" },
                ]
                return false
              } else {
            ...
            if (errors === _errs9) {
              if (data4 && typeof data4 == 'object' && !Array.isArray(data4)) {
                ...
                if ((data4.x === undefined && (missing2 = 'x')) || (data4.y === undefined && (missing2 = 'y')) || (data4.z === undefined && (missing2 = 'z'))) {
                  validate10.errors = [
                    { instancePath: instancePath + '/rotation', schemaPath: '#/properties/rotation/required', keyword: 'required', params: { missingProperty: missing2 }, message: "must have required property '" + missing2 + "'" },
                  ]
                  return false
                } else {
              ...
              if (errors === _errs17) {
                if (data8 && typeof data8 == 'object' && !Array.isArray(data8)) {
                  ...
                  if ((data8.x === undefined && (missing3 = 'x')) || (data8.y === undefined && (missing3 = 'y')) || (data8.z === undefined && (missing3 = 'z'))) {
                    validate10.errors = [
                      { instancePath: instancePath + '/scale', schemaPath: '#/properties/scale/required', keyword: 'required', params: { missingProperty: missing3 }, message: "must have required property '" + missing3 + "'" },
                    ]
                    return false
                  } else {
