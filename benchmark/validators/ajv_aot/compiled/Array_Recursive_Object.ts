// @ts-nocheck
'use strict'
export const Array_Recursive_Object = validate10
const schema11 = {
  $id: 'Array_Recursive_Object',
  minItems: 8,
  type: 'array',
  items: {
    $id: 'Recursive_Object',
    ...
    type: 'object',
    properties: { id: { type: 'string' }, nodes: { type: 'array', items: { $ref: 'Recursive_Object' } } },
    required: ['id', 'nodes'],
  },
}
const schema12 = {
...
function validate10(data, { instancePath = '', parentData, parentDataProperty, rootData = data } = {}) {
  /*# sourceURL="Array_Recursive_Object" */ let vErrors = null
  let errors = 0
  if (errors === 0) {
