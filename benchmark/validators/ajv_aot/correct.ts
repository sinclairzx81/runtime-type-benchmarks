...
export function Execute(iterations: number) {
  ...
  Cases.Benchmark(Cases.Array_Composite_Union_Discriminated, iterations, results, () => Validators.Array_Composite_Union_Discriminated)
  Cases.Benchmark(Cases.Array_Composite_Union_Literal, iterations, results, () => Validators.Array_Composite_Union_Literal)
  ...
  Cases.Benchmark(Cases.Array_Object_Required, iterations, results, () => Validators.Array_Object_Required)
  Cases.Benchmark(Cases.Array_Object_Strict, iterations, results, () => Validators.Array_Object_Strict)
  Cases.Benchmark(Cases.Array_Primitive_Boolean, iterations, results, () => Validators.Array_Primitive_Boolean)
  Cases.Benchmark(Cases.Array_Primitive_Number, iterations, results, () => Validators.Array_Primitive_Number)
  Cases.Benchmark(Cases.Array_Primitive_String, iterations, results, () => Validators.Array_Primitive_String)
  Cases.Benchmark(Cases.Array_Recursive_Object, iterations, results, () => Validators.Array_Recursive_Object)
  Cases.Benchmark(Cases.Array_Recursive_Union, iterations, results, () => Validators.Array_Recursive_Union)
  Cases.Benchmark(Cases.Array_Tuple_Number, iterations, results, () => Validators.Array_Tuple_Number)
  Cases.Benchmark(Cases.Array_Tuple_Object, iterations, results, () => Validators.Array_Tuple_Object)
  Cases.Benchmark(Cases.Array_Tuple_Union_Literal, iterations, results, () => Validators.Array_Tuple_Union_Literal)
  ...
  Cases.Benchmark(Cases.Object_Required, iterations, results, () => Validators.Object_Required)
